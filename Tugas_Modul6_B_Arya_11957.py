...
model = load_model('D:\Funiversity\Sem5\ML\M06\Tugas6_B_11957\gugelnet.h5')
...
st.title("Prediksi Kematangan Buah Naga - 1957")
...
if uploaded_files:
    ...
    for uploaded_file in uploaded_files:
        ...
        st.image(image, caption = f"Uploaded file: {uploaded_file.name}", use_column_width = True)